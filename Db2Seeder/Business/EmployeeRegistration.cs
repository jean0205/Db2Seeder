...
namespace Db2Seeder.Business
{
    public class EmployeeRegistration
    {
        ...
        public static async Task<bool> AddNISMapping(SupportRequest Request, Document_Employee Document_Employee)
        {
            try
            {
        ...
        private static async Task<bool> AddNisMapping(NisMapping nisMapping)
        {
            try
            {
