...
namespace Db2Seeder.Business
{
    public class EmployeeRegistration
    {
        ...
        private static void validatePhone(Document_Employee Document_Employee)
        {
            ...
            {
                Document_Employee.homePhoneNumber = Int64.Parse(Document_Employee.homePhoneNumber.Replace("-", string.Empty)).ToString();
            ...
            {
                Document_Employee.businessPhoneNumber = Int64.Parse(Document_Employee.businessPhoneNumber.Replace("-", string.Empty)).ToString();
            ...
            {
                Document_Employee.businessMobile = Int64.Parse(Document_Employee.businessMobile.Replace("-", string.Empty)).ToString();
            ...
            {
                Document_Employee.primaryMobileNumber = Int64.Parse(Document_Employee.primaryMobileNumber.Replace("-",string.Empty)).ToString();
