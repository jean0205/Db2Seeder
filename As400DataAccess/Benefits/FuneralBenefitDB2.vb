...
Public Class FuneralBenefitDB2
    Dim cn = DB2ConnectionS.as400
    Dim As400_lib = DB2ConnectionS.As400_lib

    Async Function InsertFuneral(Funeral As Document_FuneralBenefit) As Task(Of Integer)
        ...
        Try
            ...
            strCadena = Await SelectLastEmployer(Funeral.NisNo)
    ...
    Private Async Function InsertFuneralBENF(Funeral As Document_FuneralBenefit, Clmn As String, EmprNo As String, Emprsub As String) As Task
        Try
            ...
            Using connection As New iDB2Connection(cn)
                ...
                cmd1.Parameters("@CNCC13").Value = Funeral.CreatedOn.Year \ 100
                cmd1.Parameters("@CNYY13").Value = Funeral.CreatedOn.Year Mod 100
                cmd1.Parameters("@CNMM13").Value = Funeral.CreatedOn.Month
                cmd1.Parameters("@CNDD13").Value = Funeral.CreatedOn.Day
    ...
    Async Function InsertFuneralCLMNCS(Funeral As Document_FuneralBenefit, Clmn As String, EmprNo As String, EmprSub As String) As Task
        Try
            ...
            Using connection As New iDB2Connection(cn)
                ...
                cmd.Parameters("@CNMMCS").Value = Funeral.CreatedOn.Month
                cmd.Parameters("@CNDDCS").Value = Funeral.CreatedOn.Day
                ...
                cmd.Parameters("@SAVBCS").Value = Funeral.CompletedBy
                cmd.Parameters("@SAVTCS").Value = CDate(Funeral.CompletedTime).Year * 10000 + CDate(Funeral.CompletedTime).Month * 100 + CDate(Funeral.CompletedTime).Day

                'reassingempr
                cmd.Parameters("@EMPASCS").Value = "N"
                cmd.Parameters("@EMPRACS").Value = "0"
                cmd.Parameters("@EMPSACS").Value = "0"
                cmd.Parameters("@WBLINKCS").Value = Funeral.WebPortalLink
