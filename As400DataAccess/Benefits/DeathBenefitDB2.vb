...
Public Class DeathBenefitDB2
    Dim cn = DB2ConnectionS.as400
    Dim As400_lib = DB2ConnectionS.As400_lib

    Async Function InsertDeathBenefit(DeathBenefit As Document_DeathBenefit) As Task(Of Integer)
        ...
        Try
            ...
            strCadena = Await SelectLastEmployer(DeathBenefit.nisNo)
    ...
    Private Async Function InsertDeathBenefitBENF(DeathBenefit As Document_DeathBenefit, Clmn As String, EmprNo As String, Emprsub As String) As Task
        Try
            ...
            Using connection As New iDB2Connection(cn)
                ...
                cmd1.Parameters("@CNMM13").Value = DeathBenefit.createdOn.Month
                cmd1.Parameters("@CNDD13").Value = DeathBenefit.createdOn.Day
                ...
                'USER INITIALS
                cmd1.Parameters("@INTL13").Value = DeathBenefit.CompletedBy
        ...
        End Try
    End Function
    Private Async Function InsertDeathBenefitCLMNCS(DeathBenefit As Document_DeathBenefit, Clmn As String, EmprNo As String, EmprSub As String) As Task
        Try
            ...
            Using connection As New iDB2Connection(cn)
                ...
                cmd.Parameters("@EREGCS").Value = DeathBenefit.nisNo
                cmd.Parameters("@BENTCS").Value = "F"
                cmd.Parameters("@CNCCCS").Value = DeathBenefit.createdOn.Year \ 100
                cmd.Parameters("@CNYYCS").Value = DeathBenefit.createdOn.Year Mod 100
                cmd.Parameters("@CNMMCS").Value = DeathBenefit.createdOn.Month
                cmd.Parameters("@CNDDCS").Value = DeathBenefit.createdOn.Day
                ...
                cmd.Parameters("@SAVBCS").Value = DeathBenefit.CompletedBy
                cmd.Parameters("@SAVTCS").Value = CDate(DeathBenefit.CompletedTime).Year * 10000 + CDate(DeathBenefit.CompletedTime).Month * 100 + CDate(DeathBenefit.CompletedTime).Day

                'reassingempr
                cmd.Parameters("@EMPASCS").Value = "N"
                cmd.Parameters("@EMPRACS").Value = "0"
                cmd.Parameters("@EMPSACS").Value = "0"
                cmd.Parameters("@WBLINKCS").Value = DeathBenefit.WebPortalLink
