...
Public Class UnemploymentSEPBenefitDB2
    Dim cn = DB2ConnectionS.as400
    Public As400_lib = DB2ConnectionS.As400_lib

    Async Function InsertUnemployment(claim As Document_UEB_SEP, ClaimNumber As Integer?) As Task(Of Integer)
        ...
        Return ClaimNo
    End Function
    Private Async Function InsertClaimBENF(claim As Document_UEB_SEP, Clmn As String) As Task
        Try
            ...
            Using connection As New iDB2Connection(cn)
                ...
                If claim.ceasedSelfEmploymentDate.HasValue Then
                    cmd1.Parameters("@LWRK13").Value = CDate(claim.ceasedSelfEmploymentDate).Year * 10000 + CDate(claim.ceasedSelfEmploymentDate).Month * 100 + CDate(claim.ceasedSelfEmploymentDate).Day
                Else
        ...
        End Try
    End Function
    Private Async Function InsertClaimCLMNCS(claim As Document_UEB_SEP, Clmn As String) As Task
        Try
        ...
        End Try
    End Function
    Private Async Function InsertClaimCLMNBF(claim As Document_UEB_SEP, Clmn As String) As Task
        Try
        ...
        End Try
    End Function
    Async Function InsertBankInformationEmpe(claim As Document_UEB_SEP, Clmn As String) As Task
