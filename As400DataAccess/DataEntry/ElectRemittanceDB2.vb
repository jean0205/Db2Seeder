            ...
            Using connection As New iDB2Connection(cn)
                ...
                If rs.Read Then
                    If rs("cant") = 0 Then
                        ...
                        End If
                        cmdNempl.Parameters("@USER").Value = "WEBPORTAL"
    ...
    Async Function InsertECXE(EmpeCntr As EmployeeContributionRecord, EmprNo As String, EmprSub As String) As Task
        ...
        Try
            Using connection As New iDB2Connection(cn)
                ...
                CMDE.Parameters("@USER").Value = "WEBPORTAL"
            ...
            Using connection As New iDB2Connection(cn)
                ...
                If rs.Read Then
                    If rs("cant") > 0 Then
                        ...
                        cmdup.Parameters("@USER").Value = "WEBPORTAL"
            ...
            Using connection As New iDB2Connection(cn)
                ...
                If rs.Read Then
                    ...
                    If rs("cant") > 0 Then
                        ...
                        cmdpX.Parameters("@User10").Value = "WEBPORTAL"
            ...
            Using connection As New iDB2Connection(cn)
                ...
                If rs.Read Then
                    If rs("cant") = 0 Then
                        ...
                        cmdus.Parameters("@USER").Value = "WEBPORTAL"
